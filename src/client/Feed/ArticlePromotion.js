            ...
            <View>
                <View style={feed2.container}>
                    ...
                    <View style={feed2.body}>
                        ...
                        />
                        <View>
                            <Text style={{color:'#333', fontWeight:'700', fontSize:18}}>Role: <Text style={{color:'#666', fontWeight:'500', fontSize:15}}>{this.data.role}</Text></Text>
                            <Text style={{color:'#333', fontWeight:'700', fontSize:18}}>Description: <Text style={{color:'#666', fontWeight:'500', fontSize:15}}>{this.data.selfDescription}</Text></Text>
                        </View>
